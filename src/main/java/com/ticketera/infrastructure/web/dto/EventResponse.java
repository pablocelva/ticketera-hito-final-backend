...
public record EventResponse(
    ...
    @Schema(description = "Lugar / Recinto", example = "Teatro Nescafé de las Artes") String venue,
    @Schema(description = "Nombre del recinto", example = "Teatro Nescafé de las Artes") String venueName,
    ...
    @Schema(description = "Nombre de la banda / artista", example = "Miles Davis") String band,
